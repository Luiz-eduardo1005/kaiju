...
export const suits: Suit[] = [
  {
    id: "traje-limpeza-biológica-2006",
  ...
  },
  {
    ...
    resistencia: "Vedação parcial e filtros industriais",
  ...
  },
  {
    ...
    status: "Uso em treinamento e operações de apoio",
    resistencia: "Depende das peças usadas em campo",
    armasAcopladas: ["Fita de vedação", "Caixa de amostras", "Detector químico simples", "Máscara industrial"],
    tags: ["Traje", "Experimental", "Público"],
    descricao:
