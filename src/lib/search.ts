...
export const searchIndex: SearchableEntry[] = [
  ...
  },
  {
    ...
    title: "Loja",
    subtitle: "Compras",
    description: "Comprar comida, medicamentos comuns, roupas, equipamentos de campo, limpeza, contenção e treinamento de 2006.",
    href: "/shop",
    category: "loja",
    tags: ["Campanha"],
  },
  {
    ...
    description: "Ver itens comprados, usar consumíveis e acompanhar efeitos ativos.",
    href: "/inventory",
    category: "inventario",
    tags: ["Campanha"],
  },
  {
    ...
    description: "Ver saldo, histórico bancário e fazer Transferência Rápida entre players.",
    href: "/bank",
    category: "banco",
    tags: ["Campanha"],
  },
  {
    ...
    title: "Ficha",
    subtitle: "Personagem",
    description: "Editar dados, vida atual, vida máxima e status do personagem.",
    href: "/character",
    category: "ficha",
    tags: ["Campanha"],
  },
  {
    ...
    description: "Gerenciar players, vida, dinheiro, efeitos, inventário e logs.",
    href: "/master",
